...
**Goal:** Close the highest-value remaining local `xuanwu-gateway` gaps by strengthening MQTT, Home Assistant, Modbus, and deployment packaging without depending on upstream `XuanWu`.
...
**Files:**
- Modify: `docs/superpowers/specs/2026-03-31-xuanwu-gateway-adapter-completion-spec.md`
...
Run: `Get-Content docs\\superpowers\\specs\\2026-03-31-xuanwu-gateway-adapter-completion-spec.md -Tail 140`
...
**Files:**
- Modify: `main/xuanwu-gateway/tests/test_mqtt_adapter.py`
...
**Files:**
- Modify: `main/xuanwu-gateway/tests/test_home_assistant_adapter.py`
...
**Files:**
- Modify: `main/xuanwu-gateway/tests/test_industrial_adapters.py`
...
**Files:**
- Modify: `main/xuanwu-gateway/core/adapters/modbus_tcp_adapter.py`
...
**Files:**
- Create: `main/xuanwu-gateway/requirements.txt`
- Create: `main/xuanwu-gateway/Dockerfile`
- Modify: `main/xuanwu-device-server/docker-compose_all.yml`
- Create: `tests/test_xuanwu_gateway_docker.py`
...
Run: `python -m pytest tests/test_xuanwu_gateway_docker.py -q`
...
WORKDIR /opt/xuanwu-gateway

COPY main/xuanwu-gateway/requirements.txt /tmp/xuanwu-gateway-requirements.txt
RUN pip install --no-cache-dir -r /tmp/xuanwu-gateway-requirements.txt

COPY main/xuanwu-gateway /opt/xuanwu-gateway
...
- Test: `tests/test_xuanwu_gateway_docker.py`
...
```bash
python -m pytest main/xuanwu-gateway/tests/test_mqtt_adapter.py main/xuanwu-gateway/tests/test_home_assistant_adapter.py main/xuanwu-gateway/tests/test_industrial_adapters.py tests/test_xuanwu_gateway_docker.py -q
```
...
```bash
python -m pytest main/xuanwu-gateway/tests main/xuanwu-management-server/tests/test_local_control_plane.py main/xuanwu-management-server/tests/test_http_routes.py -q
```
...
```bash
python -m py_compile main/xuanwu-gateway/app.py main/xuanwu-gateway/core/http_server.py main/xuanwu-gateway/core/api/gateway_handler.py main/xuanwu-gateway/core/adapters/mqtt_adapter.py main/xuanwu-gateway/core/adapters/home_assistant_adapter.py main/xuanwu-gateway/core/adapters/modbus_tcp_adapter.py
```
...
```bash
git add docs/superpowers/specs/2026-03-31-xuanwu-gateway-adapter-completion-spec.md docs/superpowers/specs/2026-03-31-spec-completion-status.md docs/superpowers/plans/2026-03-31-xuanwu-gateway-gap-closure-plan.md main/xuanwu-gateway/core/adapters/mqtt_adapter.py main/xuanwu-gateway/core/adapters/home_assistant_adapter.py main/xuanwu-gateway/core/adapters/modbus_tcp_adapter.py main/xuanwu-gateway/tests/test_mqtt_adapter.py main/xuanwu-gateway/tests/test_home_assistant_adapter.py main/xuanwu-gateway/tests/test_industrial_adapters.py main/xuanwu-gateway/requirements.txt main/xuanwu-gateway/Dockerfile main/xuanwu-device-server/docker-compose_all.yml tests/test_xuanwu_gateway_docker.py
