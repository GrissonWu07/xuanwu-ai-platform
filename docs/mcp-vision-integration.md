# 视觉模型使用指南
本教程分为两部分：
- 第一部分：单模块运行xuanwu-device-gateway开启视觉模型
...
## 单模块运行xuanwu-device-gateway开启视觉模型
...
```
2025-06-01 **** - OTA接口是           http://192.168.4.7:8003/xuanwu/ota/
2025-06-01 **** - 视觉分析接口是        http://192.168.4.7:8003/mcp/vision/explain
2025-06-01 **** - Websocket地址是       ws://192.168.4.7:8000/xuanwu/v1/
...
留意xuanwu-device-gateway的日志输出，看看有没有报错。
