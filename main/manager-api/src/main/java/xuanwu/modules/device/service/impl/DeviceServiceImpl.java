package xuanwu.modules.device.service.impl;
...
import xuanwu.common.utils.DateUtils;
import xuanwu.common.utils.ToolUtil;
import xuanwu.modules.device.dao.DeviceDao;
import xuanwu.modules.device.dto.DeviceManualAddDTO;
import xuanwu.modules.device.dto.DevicePageUserDTO;
import xuanwu.modules.device.dto.DeviceReportReqDTO;
import xuanwu.modules.device.dto.DeviceReportRespDTO;
...
import xuanwu.modules.device.service.OtaService;
import xuanwu.modules.device.vo.UserShowDeviceListVO;
...
public class DeviceServiceImpl extends BaseServiceImpl<DeviceDao, DeviceEntity> implements DeviceService {
    ...
    public DeviceReportRespDTO checkDeviceActive(String macAddress, String clientId, DeviceReportReqDTO deviceReport) {
        ...
        if (StringUtils.isBlank(wsUrl) || wsUrl.equals("null")) {
            ...
            wsUrl = "ws://xuanwu.server.com:8000/xuanwu/v1/";
            ...
            if (wsUrls.length > 0) {
                ...
                log.error("WebSocket地址未配置，请登录智控台，在参数管理找到【server.websocket】配置");
                websocket.setUrl("ws://xuanwu.server.com:8000/xuanwu/v1/");
            }
        }
