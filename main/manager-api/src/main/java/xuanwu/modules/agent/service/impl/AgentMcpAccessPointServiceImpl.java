...
import xuanwu.common.utils.AESUtils;
import xuanwu.common.utils.HashEncryptionUtil;
import xuanwu.common.utils.JsonUtils;
import xuanwu.modules.agent.Enums.XuanwuMcpJsonRpcJson;
    ...
    public List<String> getAgentMcpToolsList(String id) {
        ...
        try {
            ...
            try (WebSocketClientManager client = WebSocketClientManager.build(
                ...
                client.sendText(XuanwuMcpJsonRpcJson.getInitializeJson());
                ...
                client.sendText(XuanwuMcpJsonRpcJson.getNotificationsInitializedJson());
                // 步骤3: 发送工具列表请求 - 立即发送，无需额外延迟
                log.info("发送MCP工具列表请求，智能体ID: {}", id);
                client.sendText(XuanwuMcpJsonRpcJson.getToolsListJson());
