...
import xuanwu.modules.sys.dto.EmitSeverActionDTO;
import xuanwu.modules.sys.dto.ServerActionPayloadDTO;
import xuanwu.modules.sys.dto.ServerActionResponseDTO;
import xuanwu.modules.sys.enums.ServerActionEnum;
import xuanwu.modules.sys.service.SysParamsService;
import xuanwu.modules.sys.utils.WebSocketClientManager;
...
public class ServerSideManageController {
    ...
    private Boolean emitServerActionByWs(String targetWsUri, ServerActionEnum actionEnum) {
        ...
        String redisKey = xuanwu.common.redis.RedisKeys.getTmpRegisterMacKey(deviceId);
