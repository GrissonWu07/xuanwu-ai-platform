...
`xuanwu-iot-gateway` is the protocol execution layer for IoT, industrial, and wireless devices in the local XuanWu platform stack.
...
```bash
python -m pytest main/xuanwu-iot-gateway/tests -q
```
